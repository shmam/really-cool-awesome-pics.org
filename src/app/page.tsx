    ...
    <main className={styles.main}>
      ...
      <details>
        ...
        <ul>
          ...
          <li>I actually had to implement my own lazy loading component, because safari/webkit was not respecting the native lazy loading attribute</li>
        </ul>
      </details>
      <p>tell me which ones you like: <a href="mailto:samuel.d.crochet@gmail.com">samuel.d.crochet@gmail.com</a></p>
